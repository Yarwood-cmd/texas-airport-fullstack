...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull BottomNavigationView bottomNav, @NonNull RecyclerView recyclerView,
      @NonNull SwipeRefreshLayout swipeRefresh, @NonNull Toolbar toolbar, @NonNull TextView tvEmpty,
      @NonNull TextView tvSectionTitle, @NonNull TextView tvUserInfo, @NonNull TextView tvWelcome) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, bottomNav, recyclerView,
          swipeRefresh, toolbar, tvEmpty, tvSectionTitle, tvUserInfo, tvWelcome);
    }
